...
const EmotionalIntelligence = () => {
  ...
  const domains: EmotionalIntelligenceDomain[] = [
    ...
    },
    {
      ...
      color: 'text-primary',
      bgGradient: 'bg-gradient-to-br from-primary/90 to-primary',
      progress: 50,
      isUnlocked: true,
      activities: 10,
    ...
    },
    {
      ...
      color: 'text-primary',
      bgGradient: 'bg-gradient-to-br from-primary/80 to-primary/90',
      progress: 30,
      isUnlocked: true,
      activities: 7,
    ...
    },
    {
      ...
      color: 'text-primary',
      bgGradient: 'bg-gradient-to-br from-primary/70 to-primary/80',
      progress: 10,
      isUnlocked: true,
      activities: 9,
    ...
    },
    {
      ...
      color: 'text-primary',
      bgGradient: 'bg-gradient-to-br from-primary/60 to-primary/70',
      progress: 0,
      isUnlocked: true,
      activities: 12,
