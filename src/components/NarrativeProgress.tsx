...
export const NarrativeProgressVisualization: React.FC<ProgressStoryProps> = ({
  ...
  const getEmotionColor = (emotion: string) => {
    switch (emotion) {
      case "joy": return "text-yellow-600 bg-yellow-50 border-yellow-200";
      case "pride": return "text-purple-600 bg-purple-50 border-purple-200";
      case "determination": return "text-red-600 bg-red-50 border-red-200";
      case "wonder": return "text-blue-600 bg-blue-50 border-blue-200";
              ...
              <div className="space-y-6">
                {sortedMilestones.slice(0, 6).map((milestone, index) => {
                  ...
                  return (
                    <div
                      key={milestone.id}
                      className={`relative flex gap-4 cursor-pointer thoughtful-interaction ${
                    ...
                    >
                      ...
                      {index < sortedMilestones.length - 1 && (
                        <div className="absolute left-6 top-16 w-0.5 h-16 bg-gradient-to-b from-primary to-muted" />
                      )}
                      ...
                      <div className="flex-1 min-w-0">
                            ...
                            {[...Array(10)].map((_, i) => (
                              <div
                                ...
                                className={`w-2 h-2 rounded-full ${
                                  i < milestone.impact ? 'bg-primary' : 'bg-muted'
                                }`}
                              />
                            ))}
                          </div>
                        ...
                        {/* Expanded Story */}
                        {isSelected && (
                          <div className="mt-4 p-4 bg-gradient-subtle rounded-lg border artistic-emphasis">
