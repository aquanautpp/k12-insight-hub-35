  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="mb-6 p-6 bg-white/90 rounded-lg max-w-6xl mx-auto border border-green-600">
          ...
          <p className="font-medium text-black text-justify leading-relaxed">
