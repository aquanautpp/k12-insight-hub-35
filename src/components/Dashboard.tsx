        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          ...
          >
            ...
            <div className="mantha-logo-container mb-6">
              <div className="w-[220px] md:w-[300px] lg:w-[360px] h-[220px] md:h-[300px] lg:h-[360px] rounded-full flex items-center justify-center mx-auto">
                <img 
                  src="/lovable-uploads/235c8047-21fb-4ae5-93ac-c43a5610dc1c.png"
                  alt="MANTHA - Educação Personalizada"
                  className="mantha-logo-main w-[200px] md:w-[280px] lg:w-[340px] h-auto"
                />
              </div>
            </div>
