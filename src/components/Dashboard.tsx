        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          ...
          delay: 0.2
            ...
            <div className="mantha-logo-container mb-0 mx-0 px-0 my-5 py-0">
              <div className="w-[240px] md:w-[300px] lg:w-[360px] h-[240px] md:h-[300px] lg:h-[360px] flex items-center justify-center mx-auto bg-transparent -mt-12 my-[49px] rounded-sm">
